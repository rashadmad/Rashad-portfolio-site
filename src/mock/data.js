...
export const projectsData = [
  {
    id: nanoid(),
    img: 'fullstackReactApplication_img.png',
  ...
  {
    id: nanoid(),
    img: 'RandomQuoteGenerator_img.png',
